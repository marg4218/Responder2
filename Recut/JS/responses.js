...
function promptResponses(pars) {
    var resp_div = newDiv('responses_div', 'responses_diplay');
        resp_div.setAttribute('style', 'height:900px;overflow-y:scroll')
        resp_div.classList.add('hidden-scrollbar'); // See Answer.css
...
function makeResponseTable(div) {
    ...
    <tr class="response_headers" style="position:sticky;">
        <th>Par. No.</th>
        <th>Boilerplate</th>
        <th>Text (editable)</th>
        <th>Load</th>
