...
// Mandatory  //7
    ...
    "Fail/Join Party" : "The Plaintiff has failed to join a party under OCGA § 9‑11‑19.  OCGA 9-11-12(b)(7).",
};

const defenses_cap = {
// Capacity  //2
    "Minor π" : "The Plaintiff lacks the legal capacity to sue and no personal respresentative has been properly named to act legally on their behalf.",
...
// 3rd Party //6
    ...
    "π's Driver PC" : "The Plaintiff's damages, if any, were proximately caused by the negligence of the operator of the vehicle in which Plaintiff was a passenger at the time of the occurrence at issue in this litigation, with the result that Plaintiff is not entitled to recover against this Defendant.",
    "Sudden Emergency" : "The Defendant, when faced with a sudden emergency, exercised ordinary care under the circumstances.",
    "Act of God" : "The incident at issue in this litigation was the proximate result of an act of God. OCGA § 1-3-3(3).",
...
const defenses_juri = {
// Jurisprudential //7
    "No Punitives" : "The Plaintiff is not entitled to recover punitive damages from this Defendant.",
    ...
    "No Attorney Fees" : "Plaintiff is not entitled to recover attorney’s fees and costs from Defendant under OCGA § 13-6-11.  Smith v. Stoddard, 294 Ga. App. 679 (2008).",
